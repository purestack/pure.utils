...
namespace Pure.Utils
{
    public class HttpRequestWrapper
    {
        ...
        public HttpRequestWrapper(Microsoft.AspNetCore.Http.HttpContext context)
        {
        ...
        public HttpCookieCollection Cookies
        {
            get
            {
                ...
                //    {
                //        //request.Cookies.
                //        HttpCookieWrapper cookie = new HttpCookieWrapper(key, request.Cookies[key]);
        ...
        public string[] UserLanguages
        {
            get
            {
                string lang = request.Headers[HeaderNames.AcceptLanguage];// "Accept-Language"];
        ...
        public string AbsolutePath
        {
            get
            {
                ...
                .Append(request.PathBase)
                .Append(request.Path.Value.Split('?')[0]).ToString();
        ...
        /// 请求地址
        /// </summary>
        public string UrlString => request.GetDisplayUrl();
        ...
        public string UserAgent
        {
            get
            {
                return request.Headers[HeaderNames.UserAgent];//["User-Agent"];
            }
        }
        ...
        /// 主机 HostName
        /// </summary>
        public string HostName => context == null ? Dns.GetHostName() : GetClientHostName();
        ...
        public  string IP
        {
            get
            {
                ...
                var result = address != null ? address.ToString() : string.Empty;
