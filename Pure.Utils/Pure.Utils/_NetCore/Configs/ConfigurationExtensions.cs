...
namespace Pure.Utils
{
    ...
    {
        public static IServiceCollection AddGlobalConfiguration(this IServiceCollection self, out IConfiguration config, string fileName = "appsettings", bool reloadOnChange= true)
        {
        ...
        public static IServiceCollection AddGlobalConfiguration(this IServiceCollection self, string fileName = "appsettings", bool reloadOnChange = true)
        {
            var services = self.BuildServiceProvider();
            var env = services.GetRequiredService<IHostingEnvironment>();
        ...
        public static IServiceCollection AddGlobalConfiguration(this IServiceCollection self, Action<IConfigurationBuilder> action)
        {
            var services = self.BuildServiceProvider();
            var env = services.GetRequiredService<IHostingEnvironment>();
        ...
        public static string GetConnectionStringExt(this IConfiguration configuration, string connKey = "DefaultConnection")
        {
