...
{
    public class TinyLogger : Singleton<TinyLogger>
    {
        ...
        //    logger = log4net.LogManager.GetLogger("TinyLogger");
        //}
        public TinyLogger()
        {
        ...
        public void WriteLog(String infoData)
        {
        ...
        public void WriteLog(String preFile, String infoData)
        {
            WriteLog(string.Empty, preFile, infoData);
        }

        public void WriteLog(string customDirectory, string preFile, string infoData)
        {
            lock (queueLock)
            {
        ...
        public void WriteText(string logPath, string logContent)
        {
            try
            {
