...
namespace Pure.Utils
{
    public class EmailHelper
    {
        public EmailHelper()
        {
            MailFrom = ConfigurationManager.GetValue("Mail:mailFrom");
            Passwod = ConfigurationManager.GetValue("Mail:mailPwd");
            Host = ConfigurationManager.GetValue("Mail:mailHost");
        }
