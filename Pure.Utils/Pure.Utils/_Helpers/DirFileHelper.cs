    ...
    public static class DirFileHelper
    {
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(PathHelper.CombineWithBaseDirectory(dir)))
                Directory.CreateDirectory(PathHelper.CombineWithBaseDirectory(dir));
        }
        #endregion
        ...
        {
#if !NET45
            directoryPath = Pure.Utils.HttpContext.HttpContextWrappers.Server.MapPath(directoryPath);
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            ...
            if (System.IO.File.Exists(PathHelper.CombineWithBaseDirectory(dir1)))
                System.IO.File.Move(PathHelper.CombineWithBaseDirectory(dir1), PathHelper.CombineWithBaseDirectory(dir2));
        }
        #endregion
